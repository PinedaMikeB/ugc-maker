...
async function maybeGenerateFoodAnalysisWithAI({
  ...
  const prompt = [
    ...
    "bestAdaptation must explain how to apply the reference strengths to the user's actual product.",
    "plan must be a detailed beat-by-beat production plan with sequence, tone, and B-roll logic.",
    ...
    "Make the script detailed, vivid, and performance-ready. Aim for roughly 160 to 240 words.",
    "scenes must be detailed and actionable, with concrete shot ideas and B-roll guidance.",
    "",
